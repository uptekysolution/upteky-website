...
export const allSolutions: Solution[] = [
  {
    ...
    imgSrc: "/assets/chatbot.jpg", imgAlt: "Image", // Descriptive name
  ...
  },
  {
    ...
    imgSrc: "/assets/multiplatform.png", imgAlt: "Image",// Descriptive and hyphenated
  ...
  },
  {
    ...
    imgSrc: "/assets/lead.png", imgAlt: "Image",// Descriptive and hyphenated
  ...
  },
  {
    ...
    icon: <Zap className="w-8 h-8 text-accent" />,
    imgSrc: "/assets/10.jpg", imgAlt: "Image",// Descriptive and hyphenated
  ...
  },
  {
    ...
    imgSrc: "/assets/11.jpg", imgAlt: "Image",// Descriptive and hyphenated
  ...
  },
  {
    ...
    imgSrc: "/assets/custom.png", imgAlt: "Image",// Descriptive and hyphenated
  ...
  },
  {
    ...
    imgSrc: "/assets/data-analyst.jpg", imgAlt: "Image", // Descriptive and hyphenated
  ...
  },
  {
    ...
    imgSrc: "/assets/strategy.png", imgAlt: " Image", // Descriptive and hyphenated
  ...
  },
  {
    ...
    imgSrc: "/assets/sales.png", imgAlt: "Image", // Descriptive and hyphenated
  ...
  },
  {
    ...
    imgSrc: "/assets/crm.png", imgAlt: "ERP Image", // Descriptive and hyphenated
  ...
  },
  {
    ...
    imgSrc: "/assets/digital.png", imgAlt: "ERP Image",// Descriptive and hyphenated
  ...
  description: "Streamline business operations with an AI-powered ERP agent that automates workflows, manages resources, and delivers real-time insights.",
  icon: <Settings className="w-8 h-8 text-accent" />,
  imgSrc: "/assets/erp.png" , imgAlt: "ERP Image", // Descriptive and hyphenated
  features: ["Workflow Automation", "Resource Management", "Real-Time Analytics", "Integrated Modules"],
