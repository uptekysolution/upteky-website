  ...
  const ScrollStack = () => {
    ...
    const cardData = [
      ...
      },
      {
        ...
        desc: "We create pixel-perfect designs and develop robust, scalable solutions using the latest technologies and best practices."
      },
      {
        icon: "/images/Quality Assurance.png",
        alt: "Testing icon",
        title: "Testing & Launch",
        desc: "Thorough testing and quality assurance ensure your website performs flawlessly before launch and beyond."
      }
    ];
