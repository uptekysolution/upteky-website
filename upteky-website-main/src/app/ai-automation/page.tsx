        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 xs:gap-8 sm:gap-10 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="order-1 px-3">
            ...
            <motion.p
              ...
              className="mt-6  text-center md:text-left xs:mt-8 sm:mt-10 md:mt-12 lg:mt-14 max-w-full lg:max-w-xl font-poppins font-normal text-[12px] xs:text-[12px] sm:text-[13px] md:text-[14px] lg:text-[18px] xl:text-[18px] leading-[140%] xs:leading-[145%] sm:leading-[146%] text-[#858C92]"
            >
