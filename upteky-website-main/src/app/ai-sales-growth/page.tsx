          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 xs:gap-8 sm:gap-10 md:gap-12 lg:gap-16 items-center">
            ...
            <div className="order-1">
              <motion.h1
                ...
                className="font-['Outfit'] md:mt-10 mt-14 text-center md:text-left text-white font-light text-[22px] xs:text-[22px] sm:text-[26px] md:text-[30px] lg:text-[40px] xl:text-[40px] 2xl:text-[45px] leading-[110%] xs:leading-[115%] sm:leading-[120%] md:leading-[121%]"
              >
              ...
              <motion.p
                ...
                className="mt-6 text-center md:text-left xs:mt-8 sm:mt-10 md:mt-12 lg:mt-14 max-w-full lg:max-w-xl font-poppins font-normal text-[14px] xs:text-[14px] sm:text-[14px] md:text-[14px] lg:text-[18px] xl:text-[18px] leading-[140%] xs:leading-[145%] sm:leading-[146%] text-[#858C92]"
              >
              ...
              {cards.map((card, idx) => (
                <div key={idx} className="col-span-1">
                  <div className="rounded-[16px] xs:rounded-[18px] sm:rounded-[20px] md:rounded-[22px] lg:rounded-[24px] xl:rounded-[28px] bg-[#2C3035] w-full min-h-[140px] xs:min-h-[150px] sm:min-h-[160px] md:min-h-[180px] lg:min-h-[200px] xl:min-h-[216px] mx-auto p-3 xs:p-4 sm:p-5 md:p-6 lg:p-7">
                    <h3 className="text-white font-outfit pt-1 xs:pt-2 sm:pt-3 md:pt-4 text-[14px] xs:text-[14px] sm:text-[14px] md:text-[14px] lg:text-[15px] xl:text-[18px] leading-[115%] xs:leading-[118%] sm:leading-[120%] md:leading-[121%] text-center font-medium">{card.title}</h3>
      ...
      <FadeIn>
        <section className="container mx-auto px-3 xs:px-4 sm:px-6 md:px-8 lg:px-10 py-8 xs:py-10 sm:py-12 md:py-16 lg:py-20 xl:py-24">
          <motion.h1
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            className="text-center text-white font-['Outfit'] text-[22px] text-[22px] xs:text-[22px] sm:text-[26px] md:text-[30px] lg:text-[40px] xl:text-[40px] 2xl:text-[45px] leading-[115%] xs:leading-[118%] sm:leading-[120%] md:leading-[121%] pb-6 xs:pb-7 sm:pb-8 md:pb-10 lg:pb-12"
          >
            ...
            <div className="relative rounded-[18px] lg:rounded-[20px] xl:rounded-[22px] ring-1 ring-white/10 bg-[#2C3035] overflow-hidden">
              ...
              <div className="grid grid-cols-4">
                {services.map((s) => (
                  <div
                    key={s.no}
                    // Add 'h-full' to ensure the card takes up the full height of its grid cell
                    className="px-4 lg:px-6 xl:px-8 2xl:px-10 py-6 lg:py-7 xl:py-8 h-full"
                  >
                    {/* Add 'h-full' to the ul to take the full height of the div.
              Add 'flex-col' and 'justify-between' for vertical alignment (though we'll use 'grow' on desc).
            */}
                    <ul className="flex flex-col gap-4 lg:gap-5 xl:gap-6 2xl:gap-8 h-full">
                      <li className="text-[#F58F1D] font-['Outfit'] font-normal text-[12px] lg:text-[13px] xl:text-[14px]">
                        {s.no}
                      </li>
                      <li className="text-white font-['Outfit'] font-normal text-[11px] lg:text-[20px] xl:text-[20px] 2xl:text-[20px] leading-[120%]">
                        {s.title}
                      </li>
                      <li className="text-[#9FA6AD] font-poppins font-normal text-[10px] lg:text-[16px] xl:text-[16px] 2xl:text-[16px] leading-[135%] grow">
                        {s.desc}
                      </li>
                      <li className="text-white font-poppins font-normal text-[10px] lg:text-[14px] xl:text-[14px] 2xl:text-[14px] leading-[135%]">
                        {s.cta}
                      </li>
                    </ul>
                  </div>
