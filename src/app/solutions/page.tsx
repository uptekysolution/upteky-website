          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
            {allSolutions.map((solution, index) => (
              <motion.div
                ...
                className="h-full"
              >
                <Card className="bg-card/80 border border-border/30 shadow-xl hover:shadow-accent/20 transition-all duration-300 transform hover:-translate-y-1.5 group flex flex-col overflow-hidden rounded-xl h-full backdrop-blur-md">
                  ...
                  <CardHeader className="pb-2 sm:pb-3">
                    <CardTitle className="text-lg sm:text-xl md:text-2xl font-semibold group-hover:text-accent transition-colors duration-300">{solution.title}</CardTitle>
                  </CardHeader>
                  <CardContent className="flex-grow flex flex-col pt-0 px-4 sm:px-6 pb-4 sm:pb-5">
                    <CardDescription className="text-xs sm:text-sm leading-relaxed mb-3 sm:mb-4 flex-grow">{solution.description}</CardDescription>
                  ...
                  <CardFooter className="pt-0 pb-4 sm:pb-5 px-4 sm:px-6">
                    <Button asChild variant="outline" className="w-full border-accent/30 text-accent hover:bg-accent/10 hover:text-accent group-hover:border-accent transition-colors text-sm h-9 sm:h-10">
