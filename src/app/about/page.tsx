...
export default function AboutPage() {
  ...
  return (
    ...
    <div className="bg-background text-foreground font-sans">
      ...
      <FadeIn>
      <section className="min-h-screen xl:min-h-[80vh] relative flex flex-col justify-center items-center px-4 py-10 sm:py-24 overflow-hidden">
      ...
      <section className="py-16 sm:py-20 md:py-28 bg-background/70">
        ...
        scene="https://prod.spline.design/dCkF0ryqkvCjkd8q/scene.splinecode" 
      />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {[
              ...
              <div key={i} className="group">
                <Tilt>
                  <div className="flex flex-col items-start bg-gradient-to-br from-card/70 to-card/90 border border-border/20 rounded-xl p-6 sm:p-8 transition-all duration-300 h-[300px] hover:shadow-lg hover:shadow-accent/10 hover:border-accent/30 backdrop-blur-sm">
